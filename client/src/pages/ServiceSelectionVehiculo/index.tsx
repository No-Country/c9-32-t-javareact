...
function ServiceSelectionVehiculo() {
	const navigator = useNavigate();
	const { userLocation, userData } = useGlobalData();
	const [cost, setCost] = useState<number>(493);

	const serviceType = 'vehiculo';
	const {
		register,
		reset,
		watch,
		...
		<section className="flex flex-col justify-center items-center text-center lg:flex-row gap-12 lg:items-start">
			<div className="lg:w-1/3 flex flex-col gap-8 mt-12">
				...
				<p className=" text-left">
					{userData?.name}, dejaremos tu auto impecable, atendiendo
					todo el exterior del auto sin importar la suciedad que
					tenga. Incluso es benéfico, dejando una capa anti-estática,
					la cual repele el polvo el mayor tiempo posible.
				</p>
				<img
			...
			>
				<div className="clean-container">
					<p className="w-full">Tipo de carro </p>
...
export default ServiceSelectionVehiculo;
